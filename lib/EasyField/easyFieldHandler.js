...
export function parseProps(props) {
    ...
    var name = fieldProps.name,
        ...
        childProps = _objectWithoutProperties(fieldProps, ['name', 'type', 'defaultValue', 'valuePropName', 'changePropName', 'focusPropName', 'blurPropName', 'validMessage', '__TYPE__', 'passUtil', '$defaultValue', '$defaultState', '$onFieldChange', '$validators', '$asyncValidators', '$validateLazy', '$parser', '$formatter']);
