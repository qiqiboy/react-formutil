...
export function parseProps(props) {
    var defaultValue = props.defaultValue,
        ...
        render = props.render,
        fieldProps = _objectWithoutProperties(props, ['defaultValue', 'children', 'component', 'render']);
    ...
    var name = fieldProps.name,
        ...
        childProps = _objectWithoutProperties(fieldProps, ['name', 'type', 'valuePropName', 'changePropName', 'focusPropName', 'blurPropName', 'onChange', 'onFocus', 'onBlur', '$defaultValue', '$defaultState', '$onFieldChange', '$validators', '$asyncValidators', '$validateLazy', '$parser', '$formatter', 'validMessage', '__TYPE__', 'passUtil']);
