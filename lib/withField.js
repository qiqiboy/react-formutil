    ...
    return _temp = _class = function (_Component) {
        ...
        _createClass(_class, [{
            ...
            value: function render() {
                ...
                Object.keys(Object.assign({}, others.$validators, others.$asyncValidators, config.$validators, config.$asyncValidators)).concat('$validators', '$asyncValidators', '$defaultValue', '$defaultState', 'name').forEach(function (prop) {
                    if (prop in others) {
