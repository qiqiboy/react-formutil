    ...
    _createClass(EasyField, [{
        ...
        value: function render() {
            var _props = this.props,
                ...
                fieldProps = _objectWithoutProperties(_props, ['$parser', '$formatter', 'defaultValue', 'valuePropName', 'changePropName', 'render', 'component', 'onChange', 'onFocus', 'onBlur']);
            ...
            var isNative = !isUndefined(this.props.type);
            ...
            return React.createElement(
                ...
                function ($util) {
                    ...
                    }), _defineProperty(_Object$assign, 'onFocus', function onFocus(ev) {
                        $util.$setFocused(true);

                        _onFocus && _onFocus(ev);
                    }), _defineProperty(_Object$assign, 'onBlur', function onBlur(ev) {
                        if ($util.$untouched) {
