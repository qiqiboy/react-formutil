    ...
    var FieldEnhanced = (_temp = _class = function (_Component) {
        ...
        _createClass(FieldEnhanced, [{
            ...
            value: function render() {
                ...
                ['$validators', '$asyncValidators', '$validateFirst', '$defaultValue', '$defaultState', '$onFieldChange', '$parser', '$formatter', 'name'].concat(Object.keys(Object.assign({}, config.$validators, config.$asyncValidators, others.$validators, others.$asyncValidators))).forEach(function (prop) {
                    if (prop in others) {
