...
export function createHandler($this, owner) {
    ...
    function $$reset($newState) {
        ...
        return $$merge(Object.assign({}, $baseState, utils.isFunction($defaultState) ? $defaultState(props) : $defaultState, { // self default state
    ...
    function $validate(callback) {
        return $$validatePromise = new Promise(function (resolve) {
            ...
            if ($validatePromises.length) {
                ...
                $validatePromises.push($setError(Object.assign({}, $newError, $validError)));
                ...
                validation = $setError(Object.assign({}, $newError, $validError), execCallback);
            }
