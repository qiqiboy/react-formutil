...
var Form = (_temp = _class = function (_Component) {
    ...
    this.$$defaultInitialize = function () {
        _this4.$$defaultValues = JSON.parse(JSON.stringify(_this4.props.$defaultValues));
        _this4.$$defaultStates = JSON.parse(JSON.stringify(_this4.props.$defaultStates));
    };
    ...
    this.creatDeepRegisters = function () {
        _this4.$$deepRegisters = {};

        utils.objectEach(_this4.$$registers, function (handler, name) {
            return utils.parsePath(_this4.$$deepRegisters, name, handler);
        });
    };
    ...
    this.$setValues = function ($valueTree, callback) {
        Object.assign(_this4.$$defaultValues, JSON.parse(JSON.stringify($valueTree)));
