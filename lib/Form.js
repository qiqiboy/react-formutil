    ...
    _createClass(Form, [{
        ...
        value: function render() {
            ...
            var $formutil = {
                ...
                $states: utils.toObject($stateArray, function ($states, _ref6) {
                    var path = _ref6.path,
                        $state = _ref6.$state;
                    return utils.parsePath($states, path, $state);
                }),
                $params: utils.toObject($stateArray, function ($params, _ref7) {
                    var path = _ref7.path,
                        $state = _ref7.$state;
                    return utils.parsePath($params, path, $state.$value);
                }, Object.assign({}, this.props.$defaultValues)),
                $errors: utils.toObject($stateArray, function ($errors, _ref8) {
                    var path = _ref8.path,
                        $state = _ref8.$state;
                ...
                $dirts: utils.toObject($stateArray, function ($dirts, _ref9) {
                    var path = _ref9.path,
                        $state = _ref9.$state;
                    return utils.parsePath($dirts, path, $state.$dirty);
                }),
                $touches: utils.toObject($stateArray, function ($touches, _ref10) {
                    var path = _ref10.path,
                        $state = _ref10.$state;
                    return utils.parsePath($touches, path, $state.$touched);
                }),

                $weakStates: utils.toObject($stateArray, function ($states, _ref11) {
                    var path = _ref11.path,
                        $state = _ref11.$state;
                    return $states[path] = $state;
                }),
                $weakParams: utils.toObject($stateArray, function ($params, _ref12) {
                    var path = _ref12.path,
                        $state = _ref12.$state;
                    return $params[path] = $state.$value;
                }),
                $weakErrors: utils.toObject($stateArray, function ($errors, _ref13) {
                    var path = _ref13.path,
                        $state = _ref13.$state;
                    return $errors[path] = $state.$error;
                }),
                $weakDirts: utils.toObject($stateArray, function ($dirts, _ref14) {
                    var path = _ref14.path,
                        $state = _ref14.$state;
                    return $dirts[path] = $state.$dirty;
                }),
                $weakTouches: utils.toObject($stateArray, function ($touches, _ref15) {
