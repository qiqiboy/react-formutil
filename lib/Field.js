    ...
    function Field(props) {
        ...
        _this.$handler = {
            ...
            $$reset: function $$reset($newState) {
                ...
                var $state = Object.assign({}, _this.$baseState, { $error: Object.assign({}, _this.$baseState.$error) }, $newState);

                return _this.$state = Object.assign({}, $state, { $viewValue: _this.props.$formatter($state.$value) });
            },
            $name: _this.$name,
