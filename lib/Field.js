    ...
    function Field(props) {
        ...
        _this.$handler = {
            ...
            $$reset: function $$reset($newState) {
                ...
                if (_this.$name && context.$$defaultValues) {
                ...
                return _this.$$merge(Object.assign({}, _this.$baseState, _this.props.$defaultState, { // self default state
                    $value: '$defaultValue' in _this.props ? _this.props.$defaultValue : ''
            ...
            $reset: function $reset($newState) {
                return _this.$handler.$$reset($newState);
            },
