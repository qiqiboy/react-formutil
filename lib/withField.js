        ...
        _createClass(_class, [{
            ...
            value: function render() {
                ...
                var _props = this.props,
                    ...
                    name = _props.name,
                    otherProps = _objectWithoutProperties(_props, ['$validators', '$asyncValidators', '$defaultValue', '$defaultState', 'name']);

                var fieldProps = { name: name };

                Object.keys(Object.assign({}, $validators, $asyncValidators)).forEach(function (prop) {
                ...
                [$validators, $asyncValidators, $defaultValue, $defaultState].forEach(function ($prop) {
                ...
                return React.createElement(
                    ...
                    function (props) {
                        return React.createElement(WrappedComponent, Object.assign({}, otherProps, props));
                    }
                );
            }
        }]);
