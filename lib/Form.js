...
var Form = (_temp2 = _class = function (_Component) {
    ...
    function Form() {
        ...
        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Form.__proto__ || Object.getPrototypeOf(Form)).call.apply(_ref, [this].concat(args))), _this), _this.$$registers = {}, _this.$$deepRegisters = {}, _this.$$register = function (name, handler, preName) {
            ...
            utils.objectEach(_this.$$registers, function (handler, name) {
                var $newState = $stateTree[name] || utils.parsePath($stateTree, name);
                if ($newState) {
        ...
        }, _this.$setFocuses = function ($focusedTree) {
        ...
        }, _this.$batchFocused = function ($focused) {
            return _this.$batchState({
                $focused: $focused
            });
        ...
        value: function fetchTreeFromRegisters(dataTree, process) {
            ...
            utils.objectEach(this.$$registers, function (handler, name) {
                if (name in dataTree) {
                    ...
                    var data = utils.parsePath(dataTree, name);
