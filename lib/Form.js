...
var Form = (_temp2 = _class = function (_Component) {
    ...
    _createClass(Form, [{
        ...
        value: function render() {
            ...
            var $formutil = Object.assign(this.$formutil || (this.$formutil = {}), {
    ...
    this.$getField = function (name) {
        ...
        if (field) {
            return Object.assign({}, field, field.$picker(), {
                $$formutil: _this3.$formutil
            });
        }
    };
    ...
    this.$setValues = function ($valueTree, callback) {
        Object.assign(_this3.$$defaultValues, $valueTree);
