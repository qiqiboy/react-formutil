...
export function parseProps(props) {
    ...
    var name = fieldProps.name,
        ...
        childProps = _objectWithoutProperties(fieldProps, ['name', 'type', 'valuePropName', 'changePropName', 'focusPropName', 'blurPropName', 'onChange', 'onFocus', 'onBlur', '$defaultValue', '$defaultState', '$onFieldChange', '$validators', '$asyncValidators', '$validateLazy', '$parser', '$formatter', 'validMessage', '__TYPE__']);
