    ...
    return _temp = _class = function (_Component) {
        ...
        _createClass(_class, [{
            ...
            value: function render() {
                ...
                ['$validators', '$asyncValidators', '$defaultValue', '$defaultState', 'name'].concat(Object.keys(Object.assign({}, config.$validators, config.$asyncValidators, others.$validators, others.$asyncValidators))).forEach(function (prop) {
                    if (prop in others) {
                ...
                return React.createElement(
                    Field,
                    Object.assign({}, others, fieldProps),
                    function (props) {
