    ...
    return _temp = _class = function (_Component) {
        ...
        _createClass(FormEnhanced, [{
            ...
            value: function render() {
                ...
                var formProps = _objectWithoutProperties(this.props, []);

                ['$defaultStates', '$defaultValues', '$onFormChange'].forEach(function (prop) {
                    if (prop in others) {
                        if (prop !== '$onFormChange') {
                            formProps[props] = Object.assign({}, config[prop], others[prop]);
                        }
                        delete others[prop];
                    }
                });
                ...
                return React.createElement(
                    Form,
                    Object.assign({}, config, formProps, { nodeProps: others }),
                    function ($formutil) {
        ...
        return FormEnhanced;
    }(Component), _class.displayName = 'React.formutil.withForm.' + (WrappedComponent.displayName || WrappedComponent.name || 'UnknowComponent'), _temp;
}
