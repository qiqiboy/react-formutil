    ...
    _createClass(EasyField, [{
        ...
        value: function render() {
            ...
            var _props = this.props,
                ...
                otherProps = _objectWithoutProperties(_props, ['name', 'defaultValue', '$defaultValue', '$defaultState', '$validators', '$asyncValidators', '$onFieldChange', 'validMessage', 'type', 'checked', 'unchecked', 'onChange', 'onFocus', 'onBlur']);
    ...
    _createClass(EasyFieldGroupItem, [{
        ...
        value: function render() {
            ...
            var elemProps = $groupType === 'radio' ? {
                ...
                onChange: function onChange(ev) {
                    $fieldutil.$render(ev.target.checked ? $fieldutil.$value.concat($value) : $fieldutil.$value.filter(function (value) {
                        return value !== $value;
                    }));
