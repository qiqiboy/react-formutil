...
export function parseProps(props) {
    var defaultValue = props.defaultValue,
        ...
        render = props.render,
        fieldProps = _objectWithoutProperties(props, ['defaultValue', 'valuePropName', 'changePropName', 'focusPropName', 'blurPropName', 'onChange', 'onFocus', 'onBlur', 'passUtil', 'children', 'component', 'render']);
    ...
    var $defaultValue = fieldProps.$defaultValue,
        ...
        childProps = _objectWithoutProperties(fieldProps, ['$defaultValue', '$defaultState', '$onFieldChange', '$validators', '$asyncValidators', '$validateLazy', '$parser', '$formatter', 'validMessage', '__TYPE__']);
