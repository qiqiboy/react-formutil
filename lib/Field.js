...
var Field = (_temp = _class = function (_Component) {
    ...
    this.$validate = function () {
        _this2.$syncValidate();
        _this2.$asyncValidate();
    };

    this.$syncValidate = function () {
        var _props2 = _this2.props,
            $validators = _props2.$validators,
            $asyncValidators = _props2.$asyncValidators;
        ...
        if ($validators) {
            Object.keys($validators).forEach(function (key) {
                if (key in _this2.props) {
                    var $valid = $validators[key]($value, _this2.props[key], Object.assign({}, _this2.props, {
                        $formutil: $formutil
                    }));
    ...
    this.$asyncValidate = function () {
        var $asyncValidators = _this2.props.$asyncValidators;
        var _$state2 = _this2.$state,
            $value = _$state2.$value,
            $valid = _$state2.$valid;
        var $formutil = _this2.context.$formutil;


        if ($valid && $asyncValidators) {
            var promises = Object.keys($asyncValidators).filter(function (key) {
                return key in _this2.props;
            }).reduce(function (promises, key) {
                var promise = $asyncValidators[key]($value, _this2.props[key], Object.assign({}, _this2.props, {
                    $formutil: $formutil
                }));

                if (promise && utils.isFunction(promise.then)) {
                    return promises.concat(promise.then(function () {
                        return _this2.$setValidity(key, true);
                    }, function (reason) {
                        return _this2.$setValidity(key, reason === true ? false : reason);
                    }));
                }

                _this2.$setValidity(key, promise);
