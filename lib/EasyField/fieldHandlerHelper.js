...
export function createHandler($fieldutil, props, childProps) {
    ...
    var _defaultProps$props = Object.assign({}, defaultProps, props),
        valuePropName = _defaultProps$props.valuePropName,
        changePropName = _defaultProps$props.changePropName,
        focusPropName = _defaultProps$props.focusPropName,
        blurPropName = _defaultProps$props.blurPropName,
        onChange = _defaultProps$props.onChange,
        onFocus = _defaultProps$props.onFocus,
        onBlur = _defaultProps$props.onBlur,
        passUtil = _defaultProps$props.passUtil;
...
export function parseProps(props) {
    ...
    var name = fieldProps.name,
        ...
        childProps = _objectWithoutProperties(fieldProps, ['name', 'valuePropName', 'changePropName', 'focusPropName', 'blurPropName', 'onChange', 'onFocus', 'onBlur', '$defaultValue', '$defaultState', '$onFieldChange', '$validators', '$asyncValidators', '$validateLazy', '$parser', '$formatter', 'validMessage', '__TYPE__']);
