    ...
    _createClass(EasyField, [{
        ...
        value: function render() {
            ...
            var _props = this.props,
                ...
                otherProps = _objectWithoutProperties(_props, ['name', 'defaultValue', '$defaultValue', '$defaultState', '$validators', '$asyncValidators', 'validMessage', 'type', 'checked', 'unchecked', 'onChange', 'onFocus', 'onBlur']);
